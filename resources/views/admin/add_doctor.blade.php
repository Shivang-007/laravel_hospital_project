            ...
            <div class="container">
                ...
                <form action="{{url('upload_doctor')}}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input type="text" style="color: lightblue" name="name" class="form-control" id="name" placeholder="Name" required>
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="inputEmail3" class="col-sm-2 col-form-label">Email</label>
                        <div class="col-sm-10">
                            <input type="email" style="color:  lightblue" name="email" class="form-control" id="inputEmail3" placeholder="Email" required>
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="contact" class="col-sm-2 col-form-label">Contact No.</label>
                        <div class="col-sm-10">
                            <input type="number" style="color:  lightblue" name="phone" class="form-control" id="contact" placeholder="contact" required>
                        </div>
                    </div>
                    <div class="form-group row">
                    ...
                    <div class="form-group row">
                        <label for="image" class="col-sm-2 col-form-label">Doctor's Image</label>
                        <div class="col-sm-10">
